import 'dart:ui' show Color, FontWeight, TextStyle;
...
class NowUIColors {
  ...
  static const Color m_blue_5 = Color.fromRGBO(0, 63, 117, 0.1);

  static const Color m_blue = Color.fromRGBO(0, 63, 117, 1.0);
  static const Color m_appbar_bg = Color.fromRGBO(247, 168, 3, 1.0);
  static const Color m_bg = Color.fromRGBO(255, 255, 255, 1.0);
  static const Color m_highlight = Color.fromRGBO(187, 187, 221, 1.0);
  static const Color m_brown = Color.fromRGBO(166, 124, 46, 1.0);
  static const Color backgroundColor = Color.fromRGBO(240, 242, 250, 1.0);

  static const Color cardPieceBackgroundColor = Color.fromRGBO(240, 242, 250, 1.0);

  static const Color m_btn = Color.fromRGBO(247, 168, 3, 1.0);
